...
const PRODUCT = {
  ...
  name: "واقي المرتبة المضاد للماء",
  price: 229,
...
const SIZES: { label: string; price: number }[] = [
  { label: "60×120 سم",  price: 119 },
  { label: "90×190 سم",  price: 149 },
  { label: "120×190 سم", price: 159 },
  { label: "140×190 سم", price: 169 },
  { label: "140×200 سم", price: 179 },
  { label: "160×190 سم", price: 199 },
  { label: "160×200 سم", price: 209 },
  { label: "180×200 سم", price: 219 },
  { label: "190×200 سم", price: 229 },
  { label: "200×200 سم", price: 239 },
];
...
const TRUST_BADGES = [
  { icon: Droplets, label: "مضاد للماء 100%", desc: "غشاء TPU معتمد" },
  { icon: Wind,     label: "قابل للتنفس",      desc: "راحة طوال الليل" },
  { icon: Shield,   label: "مضاد للعث",        desc: "مضاد للبكتيريا معتمد" },
  { icon: Truck,    label: "توصيل سريع",       desc: "في جميع أنحاء المغرب" },
  { icon: RotateCcw,label: "إرجاع خلال 30 يوم", desc: "مضمون أو استرداد المبلغ" },
  { icon: Star,     label: "4.8 / 5",          desc: "بناءً على أكثر من 240 تقييم" },
];
...
const LIFESTYLE_BLOCKS = [
  {
    ...
    text: "يشكّل غشاؤنا من TPU فائق النعومة حاجزاً مانعاً للتسرّب دون طقطقة البلاستيك الموجودة في الواقيات التقليدية. تنام على سطح ناعم وصامت وبارد — تماماً كأنه بلا واقٍ، لكن بكامل الأمان الذي تحتاجه.",
    imageLeft: true,
  },
  {
    image: "https://res.cloudinary.com/diptsoc4h/image/upload/v1783091043/A2_ymk4qg.jpg",
    title: "مثالي لكل العائلة",
    text: "سواء لحماية مرتبة طفلك من حوادث الليل، أو لشخص مسنّ، أو ببساطة للوقاية من التعرّق، يتكيّف واقي المرتبة مع كل الاحتياجات. حل واحد لكل المنزل.",
    imageLeft: false,
  },
  {
    image: "https://res.cloudinary.com/diptsoc4h/image/upload/v1783091089/A6_pgu8ij.jpg",
    title: "تركيب في 30 ثانية",
    text: "بفضل المطاطات الأربع المعزّزة في الزوايا، يوضع الواقي ويُنزع في ثوانٍ. يبقى مثبّتاً تماماً طوال الليل، حتى على المراتب الأكثر سماكة، دون أن ينزلق أو ينثني.",
    imageLeft: true,
  },
  {
    image: "https://res.cloudinary.com/diptsoc4h/image/upload/v1783091089/A8_an5y7s.jpg",
    title: "عناية بلا عناء",
    text: "قابل للغسل في الغسالة على 40 درجة، يجف بسرعة في الهواء الطلق ويحافظ على كل خصائصه المضادة للماء بعد كل غسلة. لا معالجة خاصة ولا حاجة لمجفّف — نظافة لا تشوبها شائبة بأقل جهد.",
    imageLeft: false,
  },
];

const COMPARISON = [
  { feature: "حماية من السوائل",              ours: true,  classic: false },
  { feature: "سطح صامت (بدون طقطقة)",         ours: true,  classic: false },
  { feature: "قابل للتنفس وتنظيم الحرارة",     ours: true,  classic: false },
  { feature: "مضاد للعث والبكتيريا",           ours: true,  classic: false },
  { feature: "مطاطات معزّزة في 4 زوايا",       ours: true,  classic: true  },
  { feature: "قابل للغسل في الغسالة",          ours: true,  classic: true  },
  { feature: "ضمان 12 شهراً",                ours: true,  classic: false },
  { feature: "كل المقاسات المغربية",          ours: true,  classic: false },
];

const FAQ_ITEMS = [
  {
    q: "هل يُصدر واقي المرتبة صوتاً أثناء الليل؟",
    a: "لا. غشاؤنا من TPU مصمّم خصيصاً ليكون صامتاً، على عكس الواقيات البلاستيكية التقليدية التي تطقطق. لن تلاحظ حتى وجوده.",
  },
  {
    q: "هل يمكن غسله في الغسالة؟",
    a: "نعم، قابل للغسل في الغسالة على 40 درجة. يجف بسرعة في الهواء الطلق ويحافظ على خصائصه المضادة للماء والعث بعد كل غسلة، دون أي معالجة إضافية.",
  },
  {
    q: "هل يناسب مرتبة سميكة (إسفنج ذاكرة)؟",
    a: "بالتأكيد. تتكيّف المطاطات المعزّزة في الزوايا الأربع مع المراتب حتى 35 سم سماكة، بما في ذلك مراتب إسفنج ذاكرة الشكل أو اللاتكس.",
  },
  {
  ...
  {
    q: "هل يمكنني طلب مقاس مخصّص؟",
    a: "نعم. للأبعاد الخاصة (أسرّة الأطفال، الأسرّة الطبية…)، تواصل معنا مباشرة عبر واتساب وسنجهّز لك عرضاً على المقاس.",
  },
];

/* ─── PAGE ──────────────────────────────────────────────────────────── */

export default function ProtegeMatelasPageAr() {
    ...
    <main dir="rtl" className="bg-white">
      ...
      <section className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 flex justify-start">
          <Link
            href="/produits/protege-matelas-impermeable"
          ...
          <div className="flex flex-col gap-6">
            <div>
              ...
              <h1 className="mt-2 text-3xl font-bold text-dark-gray">
                واقي المرتبة المضاد للماء
              </h1>
              <p className="mt-3 leading-relaxed text-gray-500">
                غشاء TPU صامت، قابل للتنفس، مضاد للعث والبكتيريا. احمِ مرتبتك دون التضحية بالراحة.
              </p>
              <div className="mt-3 flex items-center gap-2">
                {[1, 2, 3, 4, 5].map((s) => (
                  <Star key={s} size={16} className="fill-yellow-400 text-yellow-400" />
                ))}
                <span className="text-sm text-gray-500">4.8 / 5 — أكثر من 240 تقييم</span>
              </div>
            </div>
