...
const LIFESTYLE_BLOCKS = [
  ...
  },
  {
    ...
    title: "غطاء ناعم وصحي",
    text: "الغطاء من الميكروفايبر فائق النعومة قابل للفك والغسل في الغسالة على 40 درجة. معالَج ضد العث، يحافظ على بيئة صحية ليلة بعد ليلة، مثالي للأشخاص المصابين بالحساسية. يجف بسرعة ويحافظ على نعومته بعد كل غسلة.",
    imageLeft: false,
  },
];
    ...
    <main dir="rtl" className="bg-white">
      ...
      <section className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 flex justify-start">
          <Link
            href="/produits/oreiller-memoire-forme"
