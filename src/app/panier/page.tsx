    ...
    return (
      <section className="bg-white py-20">
        <div className="mx-auto flex max-w-7xl flex-col items-center gap-3 px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="text-gray-500">Parcourez nos produits et ajoutez-les à votre panier.</p>
          <Link
            href="/produits"
  ...
  return (
    <section className="bg-white py-12 sm:py-16">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <h1 className="mb-8 text-3xl font-bold text-dark-gray">Votre panier</h1>
            ...
            >
              ...
              <div className="flex items-center gap-2 rounded-xl border border-gray-200 px-2 py-1">
                <button
                  ...
                  className="flex h-7 w-7 items-center justify-center rounded-lg text-dark-gray hover:bg-light-gray"
                >
                  <Minus size={14} />
                </button>
              ...
              <button
                ...
                className="flex h-9 w-9 items-center justify-center rounded-xl text-gray-400 hover:bg-red-50 hover:text-red-500"
              >
                <Trash2 size={18} />
              </button>
            </div>
        ...
        <div className="mt-8 flex flex-col items-end gap-4 border-t border-gray-100 pt-6">
          ...
          <Link
            href="/commande"
            className="inline-flex items-center justify-center rounded-xl bg-primary px-8 py-3.5 text-sm font-medium text-white shadow-md transition-all hover:bg-primary-dark hover:shadow-lg"
          >
            Passer la commande
          </Link>
        </div>
