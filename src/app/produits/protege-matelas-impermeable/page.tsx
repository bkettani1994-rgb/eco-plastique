...
const LIFESTYLE_BLOCKS = [
  {
    image: "https://picsum.photos/seed/pm-block-1/900/700",
  ...
  {
    image: "https://picsum.photos/seed/pm-block-2/900/700",
  ...
  {
    image: "https://picsum.photos/seed/pm-block-3/900/700",
  ...
  {
    image: "https://picsum.photos/seed/pm-block-4/900/700",
    ...
    <main className="bg-white">
      ...
      <section className="bg-primary py-14 text-center">
        <div className="mx-auto max-w-2xl px-4">
          ...
          <p className="mt-2 text-primary-dark/80 text-white/80">
